...
var _connectAdvanced = __webpack_require__(19);
...
var _visibleSiteList = __webpack_require__(66);

var _visibleSiteList2 = _interopRequireDefault(_visibleSiteList);
...
_reactDom2.default.render(_react2.default.createElement(
  ...
  { store: store },
  _react2.default.createElement(_visibleSiteList2.default, null)
...
var _selectorFactory = __webpack_require__(62);
...
var _verifySubselectors = __webpack_require__(63);
...
function vvvSitesApp() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var action = arguments[1];

  switch (action.type) {
    case _actions.ADD_SITE:
      return _extends({}, state, {
        sites: [].concat(_toConsumableArray(state.sites), [_extends({}, action.site, {
          expanded: false
        })])
      });
    case _actions.TOGGLE_SITE:
      return _extends({}, state, {
        sites: state.sitesmap(function (site, index) {
...
var ADD_SITE = exports.ADD_SITE = 'ADD_SITE';
var TOGGLE_SITE = exports.TOGGLE_SITE = 'TOGGLE_SITE';
...
var VisibleSiteList = (0, _reactRedux.connect)(mapStateToProps /* , mapDispatchToProps */)(_siteList2.default);

exports.default = VisibleSiteList;
...
var Site = function Site(_ref) {
  ...
  if (site.hosts.length > 0) {
    var sites = site.hosts.map(function (host) {
      return _react2.default.createElement(
        'a',
        { key: 'vvv_site_link_' + host, className: 'vvv_site_link', href: 'http://' + host },
        host
      );
    });
  ...
  if (site.skip_provisioning) {
    ...
    provisioned = _react2.default.createElement(
      'a',
      { target: '_blank', rel: 'noopener noreferrer', href: 'https://varyingvagrantvagrants.org/docs/en-US/vvv-config/#skip_provisioning' },
...
Site.propTypes = {
  ...
  site: _propTypes2.default.shape({
    ...
    hosts: _propTypes2.default.arrayOf(_propTypes2.default.string)
  })
};
Site.defaultProps = {
  name: 'unknown site',
